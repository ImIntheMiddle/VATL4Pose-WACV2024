...
class PoseTrack(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            'GT_FOLDER': os.path.join(code_path, 'data/gt/PoseTrackReid/posetrack_data/annotations/val/'),
            # Location of GT data
    ...
    def get_raw_seq_data(self, tracker, seq):
        ...
        for t, (ignore_regions_t, gt_dets_t, tracker_dets_t, image_id_t1, image_id_t2) in enumerate(
                zip(raw_gt_data_new['ignore_regions'],
