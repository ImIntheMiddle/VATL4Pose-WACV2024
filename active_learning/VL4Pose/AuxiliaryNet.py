...
# AUX_ARCH = {fc: [128, 64, 32, 16], conv_or_avg_pooling: 'conv'}

class AuxNet(nn.Module):
    def __init__(self):#num_feat, pose_num_channels, convolution=False, pose_feat_shape=(64, 32, 16, 8, 4)):
        """
